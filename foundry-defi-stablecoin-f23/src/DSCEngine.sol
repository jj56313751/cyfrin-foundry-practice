 ...
 * @author Shane Wang
 *
 * This system is designed to be as minimal as possible, and have the tokens maintains 1 token == $1 peg .
 ...
 *
 * @notice The contract is the core of the DSC system. It handles all the logic for minting and redeeming DSC, as well as depositing and withdrawing collateral.
...
contract DSCEngine is ReentrancyGuard {
    ...
    DecentralizedStableCoin private immutable i_dsc; // address of the DSC contract
    ...
    // If someone is almost under-collateralization, we will pay you to liquidate them
    /**
        ...
        nonReentrant
    {
        ...
        // We should implement a feature to liquidate in the event of the protocol is insolvent
        // And sweep extra amounts into a treasury
        // 0.05 * 0.1 = 0.005 ETH, Getting 0.05 + 0.005 = 0.055 ETH
    ...
    /**
     * description: returns how close the user is to liquidation
    ...
    function getClolatteralBalanceOfUser(address user, address token) external view returns(uint256) {
